// Simula il flusso dei middleware sul frontend

// Array dei middleware e frecce della pipeline
const stages = [
...
const consoleDiv = document.getElementById("consoleContent"); // Div console

// Funzione per loggare nella console simulata
function logToConsole(message, type = "info") {
  const line = document.createElement("div");
  line.textContent = `[${new Date().toLocaleTimeString()}] ${message}`;
  if (type === "error") line.style.color = "red";
  else if (type === "warn") line.style.color = "orange";
  consoleDiv.appendChild(line); // Aggiunge linea alla console
  consoleDiv.scrollTop = consoleDiv.scrollHeight; // Scroll automatico
}

// Evidenzia il middleware corrente e freccia
